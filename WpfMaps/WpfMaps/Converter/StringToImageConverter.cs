        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (value is string name)
            {
                ...
                if (name == "Mount Sinai Hospital")
                    return new BitmapImage(new Uri("Assets/Map/Images/hospital_1.jpg", UriKind.Relative));
                else if (name == "NewYork-Presbyterian Hospital")
                    return new BitmapImage(new Uri("Assets/Map/Images/hospital_2.jpg", UriKind.Relative));
                else if (name == "NYU Langone Health")
                    return new BitmapImage(new Uri("Assets/Map/Images/hospital_3.jpg", UriKind.Relative));
                else if (name == "Lenox Hill Hospital")
                    return new BitmapImage(new Uri("Assets/Map/Images/hospital_4.jpg", UriKind.Relative));
                else if (name == "Bellevue Hospital Center")
                    return new BitmapImage(new Uri("Assets/Map/Images/hospital_5.jpg", UriKind.Relative));
                else if (name == "Mount Sinai West")
                    return new BitmapImage(new Uri("Assets/Map/Images/hospital_6.jpg", UriKind.Relative));
                else if (name == "Mount Sinai Beth Israel")
                    return new BitmapImage(new Uri("Assets/Map/Images/hospital_7.jpg", UriKind.Relative));
